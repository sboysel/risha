function lets-pico-mx-top-plate_extrude_8_outline_fn(){
...
function lets-pico-mx-top-plate_extrude_6_outline_fn(){
    return new CSG.Path2D([[139.875,-190.5],[139.875,-100.0125]]).appendArc([142.875,-97.0125],{"radius":3,"clockwise":true,"large":false}).appendPoint([242.875,-97.0125]).appendArc([245.875,-100.0125],{"radius":3,"clockwise":true,"large":false}).appendPoint([245.875,-190.5]).appendArc([242.875,-193.5],{"radius":3,"clockwise":true,"large":false}).appendPoint([142.875,-193.5]).appendArc([139.875,-190.5],{"radius":3,"clockwise":true,"large":false}).close().innerToCAG()
.subtract(
    new CSG.Path2D([[226.35,-187.975],[240.35,-187.975]]).appendPoint([240.35,-173.975]).appendPoint([226.35,-173.975]).appendPoint([226.35,-187.975]).close().innerToCAG()
.union(
    ...
    new CSG.Path2D([[145.4,-159.4],[159.4,-159.4]]).appendPoint([159.4,-145.4]).appendPoint([145.4,-145.4]).appendPoint([145.4,-159.4]).close().innerToCAG()
                ...
                function lets-pico_case_fn() {
                    

                // creating part 0 of case lets-pico
                let lets-pico__part_0 = lets-pico-mx-top-plate_extrude_8_outline_fn();

                // make sure that rotations are relative
                let lets-pico__part_0_bounds = lets-pico__part_0.getBounds();
                let lets-pico__part_0_x = lets-pico__part_0_bounds[0].x + (lets-pico__part_0_bounds[1].x - lets-pico__part_0_bounds[0].x) / 2
                let lets-pico__part_0_y = lets-pico__part_0_bounds[0].y + (lets-pico__part_0_bounds[1].y - lets-pico__part_0_bounds[0].y) / 2
                lets-pico__part_0 = translate([-lets-pico__part_0_x, -lets-pico__part_0_y, 0], lets-pico__part_0);
                lets-pico__part_0 = rotate([0,0,0], lets-pico__part_0);
                lets-pico__part_0 = translate([lets-pico__part_0_x, lets-pico__part_0_y, 0], lets-pico__part_0);

                lets-pico__part_0 = translate([0,0,0], lets-pico__part_0);
                let result = lets-pico__part_0;
                
            

                // creating part 1 of case lets-pico
                let lets-pico__part_1 = lets-pico-mx-top-plate_extrude_6_outline_fn();

                // make sure that rotations are relative
                let lets-pico__part_1_bounds = lets-pico__part_1.getBounds();
                let lets-pico__part_1_x = lets-pico__part_1_bounds[0].x + (lets-pico__part_1_bounds[1].x - lets-pico__part_1_bounds[0].x) / 2
                let lets-pico__part_1_y = lets-pico__part_1_bounds[0].y + (lets-pico__part_1_bounds[1].y - lets-pico__part_1_bounds[0].y) / 2
                lets-pico__part_1 = translate([-lets-pico__part_1_x, -lets-pico__part_1_y, 0], lets-pico__part_1);
                lets-pico__part_1 = rotate([0,0,0], lets-pico__part_1);
                lets-pico__part_1 = translate([lets-pico__part_1_x, lets-pico__part_1_y, 0], lets-pico__part_1);

                lets-pico__part_1 = translate([0,0,0], lets-pico__part_1);
                result = result.subtract(lets-pico__part_1);
